  ...
  return (
    <main className="home">
      ...
      <div className="overview">
        ...
        <h1>OVERVIEW</h1>
        <p>
          Tech enthusiast at 21, specializing in web development. Proficient in
          HTML, CSS, and JavaScript, I create user-friendly and visually
          appealing websites. A meticulous and creative problem solver, I thrive
          in collaborative settings. Committed to staying current with
          technology trends, my portfolio reflects my dedication to impactful
          web solutions.
        </p>
        <div className="cards">
      ...
      <div className="findMe">
        <h1>
          <span className="blue">Find Me Online</span>
        </h1>
        <div className="links">
          <a href="https://github.com/TheToadSannin" target="_blank">
            <i class="fa-brands fa-github" style={{ color: "#FFFFFF" }}></i>
          </a>
          <a href="https://twitter.com/TheToadSannin" target="_blank">
            <i
              class="fa-brands fa-square-twitter"
              style={{ color: "#FFFFFF" }}
            ></i>
          </a>
          <a href="www.linkedin.com/in/gaurav-panwar-85822a22b" target="_blank">
      ...
      <div className="projects" id="projects">
        ...
        <div className="project-cards">
          <ProjectCard
            link={"https://auto-applica.vercel.app/"}
            img={auto_app}
            name={"Auto-Applica"}
            detail={
              "Designed and developed a secure web application empowering students to effortlessly generate, submit, and communicate with teachers via encrypted channels, enhancing academic workflows and data privacy in education."
            }
          />
          <ProjectCard
            ...
            name={"Video-Tronics"}
            detail={
              "Crafted a specialized web application for a cutting-edge drone and camera repair center, streamlining repair requests, inventory management, and secure client communication. Elevating efficiency and customer satisfaction in the tech repair industry."
            }
          />
          <ProjectCard
            ...
            detail={
              "Crafted a user-centric web app for cafeteria feedback, bridging students and culinary services. Enhancing satisfaction and driving culinary service improvements through streamlined feedback collection."
            }
          />
        </div>
        <div>
      ...
      <div className="qualifications">
        ...
        <div className="quali-cards">
          <QualiCard
            type="College / Unviersity"
            image={collegeLogo}
            detail="Pursuing Bachelor Of Technology in Computer Science and Engineering(2020 - 2024) from Amity University Madhya Pradesh Gwalior . With a major in Artificial Intelligence and Machine Learning. Holding the aggregate CGPA of 7.55."
          />
          <QualiCard
            type="Higher secondary"
            image={springdalesLogo}
            detail="Completed Higher Secondary schooling from Springdales School from Kota Rajasthan with a major in Science and Mathematics with the aggregate percentage of 67%."
          />
          <QualiCard
            type="High School"
            image={lotusLogo}
            detail="Completed High Schooling from Lotus Valley School in Mandsaur Mahdya Pradesh. with the Aggregate of 72%. "
          />
        </div>
      </div>
      <div className="contactus" id="contactus">
        ...
        <div className="inputs">
          <h1>
            <span className="blue">CONTACT ME HERE</span>
          </h1>
